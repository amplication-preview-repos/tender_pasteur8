...
export class ItemControllerBase {
  ...
  async createItem(@common.Body() data: ItemCreateInput): Promise<Item> {
    return await this.service.createItem({
      data: {
        ...
        itemBonuses: data.itemBonuses
          ? {
              connect: data.itemBonuses,
            }
          : undefined,
      },
      select: {
  ...
  async findCharacter(
    ...
    const results = await this.service.findCharacter(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Delete("/:id/character")
  @nestAccessControl.UseRoles({
    resource: "Item",
    action: "update",
    possession: "any",
  })
  async disconnectCharacter(
    @common.Param() params: ItemWhereUniqueInput,
    @common.Body() body: CharacterWhereUniqueInput[]
  ): Promise<void> {
    const data = {
