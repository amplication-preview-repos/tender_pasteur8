...
export class ItemResolverBase {
  ...
  async createItem(@graphql.Args() args: CreateItemArgs): Promise<Item> {
    return await this.service.createItem({
      ...
      data: {
        ...
        itemBonuses: args.data.itemBonuses
          ? {
              connect: args.data.itemBonuses,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Character], { name: "character" })
  @nestAccessControl.UseRoles({
    resource: "Character",
    action: "read",
    possession: "any",
  ...
  async findCharacter(
    ...
    const results = await this.service.findCharacter(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => ItemBonus, {
    nullable: true,
    name: "itemBonuses",
  })
  @nestAccessControl.UseRoles({
  ...
  async getItemBonuses(
    @graphql.Parent() parent: Item
  ): Promise<ItemBonus | null> {
    const result = await this.service.getItemBonuses(parent.id);
