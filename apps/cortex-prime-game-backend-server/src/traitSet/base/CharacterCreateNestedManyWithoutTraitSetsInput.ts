...
@InputType()
class CharacterCreateNestedManyWithoutTraitSetsInput {
...
export { CharacterCreateNestedManyWithoutTraitSetsInput as CharacterCreateNestedManyWithoutTraitSetsInput };
